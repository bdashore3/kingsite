  ...
  return (
    <div className="flex flex-col min-h-screen border-solid">
      <div className="flex-grow inline-flex items-center flex-col overflow-visible">
        ...
        <div className="lg:px-10 mx-4 lg:mx-48 rounded-3xl relative bg-lightbg font-medium max-w-7xl">
          <p className="text-whitesmoke text-sm lg:text-xl p-6 font-paragraph tracking-wide leading-normal lg:leading-relaxed">
            My name is Brian Dashore, a self-taught hobbyist developer, and I am studying for a
            degree in medicine. I am currently located in Long Island, New York.
            <br />
            <br />
            From sixth grade, I was interested in medicine and learning how the human body works.
            I’ve always had an inherent desire to help people since so many helped me when I
            suffered through chronic illness. I have spent many years over studying biology,
            anatomy, nutrition, and other fields of medicine. Eventually, I was accepted to NYIT’s
            7-year BS/DO program in February of 2020. I am currently studying there and will obtain
            my DO in 7 years. From there, I am planning to study immunology and make a
            career/practice for myself.
            <br />
            ...
            bots using the Discord, Twitch, and Twitter APIs. These bots are semi-popular, and I
            have designed them with goals of educating the public and making my social media life
            easier.
            <br />
            <br />
            I feel that development ties well into medicine and learning multiple
            ...
            <br />
            <span className="text-yellow-300 ws-s">Rust, C#, JS, Python, HTML, CSS, C</span>
            <br />
            <br />
